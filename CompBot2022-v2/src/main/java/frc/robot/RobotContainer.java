...
public class RobotContainer {
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("leaveTarmac", new leaveTarmac( m_driveSystem ));
    SmartDashboard.putData("debugCommands", new debugCommands());
  ...
  private void configureButtonBindings() {
    ...
    button8.whenHeld(new moveDumper( m_dumperSystem ) ,true);
        SmartDashboard.putData("button8",new moveDumper( m_dumperSystem ) );
