...
// Joysticks
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new driveDistanceCommand(m_driveSystem));
    ...
    SmartDashboard.putData("changeIntakeDirectionCommand", new changeIntakeDirectionCommand( m_intakeSystem ));
    SmartDashboard.putData("pickupCargoCommand", new pickupCargoCommand( m_intakeSystem ));
    SmartDashboard.putData("moveDumperCommand", new moveDumperCommand( m_dumperSystem, m_driveSystem ));
    ...
    m_chooser.setDefaultOption("Autonomous Commands", new driveDistanceCommand(m_driveSystem));
...
// complete need to test 
    ...
    b_moveDumper.whenHeld(new moveDumperCommand( m_dumperSystem, m_driveSystem ) ,true);

    final JoystickButton b_startDriveTrain = new JoystickButton(joystick1, Constants.RightJoystickConstants.kStartDriveTrain);
    b_startDriveTrain.whenPressed(new startDriveTrainCommand(m_driveSystem),true);       
    ...
    final JoystickButton b_getDumperSensor = new JoystickButton(joystick1, Constants.RightJoystickConstants.kGetDumperSensor);        
    b_getDumperSensor.whenPressed(new getDumperSensorCommand( m_dumperSystem ) ,true);

    final JoystickButton b_resetDumperSensor = new JoystickButton(joystick1, Constants.RightJoystickConstants.kResetDumperSensor);        
    b_resetDumperSensor.whenPressed(new resetDumperSensorCommand( m_dumperSystem ) ,true);
